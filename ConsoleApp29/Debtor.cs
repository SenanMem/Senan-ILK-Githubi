...
namespace ConsoleApp29
{
    class Debtor
    {
        ...
        {
            return $"{this.FullName} {this.BirthDay.ToShortDateString()} {this.FullName} {this.Email} {this.Address} {this.Debt}";
        }
    }
    class DebtorList
    {
        public static List<Debtor> GetDebtors()
        {
            return new List<Debtor> {
                ...
                new Debtor("Pamela H. Custom", DateTime.Parse("November 20, 1959"), "123-456-789", "PamelaHBeauchamp@jourrapide.com", "3239 Tori Lane Salt Lake City, UT 84104", 6588),
            };
        }
    }
}
